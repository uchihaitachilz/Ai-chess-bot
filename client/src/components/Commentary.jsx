    ...
    <div className="bg-white rounded-lg shadow-2xl p-6 h-full flex flex-col">
      ...
      <div className="mb-4">
        <div className="flex items-center gap-3 mb-3">
          <div className="w-20 h-20 rounded-full overflow-hidden bg-gradient-to-br from-purple-400 to-pink-400 flex items-center justify-center shadow-lg flex-shrink-0 border-2 border-purple-500 relative">
            {imageSrc && !imageError ? (
              <img 
                src={imageSrc} 
                alt="SadisticTushi" 
